...
class EmployeeRegistrationScreen
  ...
  @override
  State<EmployeeRegistrationScreen>
      createState() =>
...
class _EmployeeRegistrationScreenState
  ...
  Future<void>
      _resetIncompleteEmployeeProfile()
      async {
  ...
  Future<void> submit()
    ...
    try {
      ...
      final userData = {
        ...
        'carModel':
            carModelCtrl.text.trim(),

        'carPlate':
            carPlateCtrl.text.trim(),
  ...
  child: const Column(
    ...
    children: [
      ...
      Text(
        ...
        "Create your professional profile and let customers see your rating and profession before booking.",
